...
Ordered pairs are introduced as a structure distinct from sets, often used to in mathematics to define co-ordinate systems, as well as rigorous definitions of functions and relations.
